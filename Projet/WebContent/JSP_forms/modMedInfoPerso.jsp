    ...
    <div class="container">
        ...
        <header class="jumbotron hero-spacer">
            ...
            <form action="Control" method="post" >
            		<table>
        			<tr><td>Nom:</td>	 			<td><input type="text" name="ModMedNom"> </td></tr>
        			...
        			<tr><td>Specialité:</td>	 	<td><input type="text" name="ModPatSexe"> </td></tr>
            		</table>
            		<br>
            		<button name="ModMedSubmit">Submit</button>
            </form>
